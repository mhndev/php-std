 ...
 * @package mhndev\digipeyk\services\accept
 */
class AcceptPrecedence
{
    ...
    public static function precedenceMedia($mediaRanges)
    {
        ...
        foreach ($mediaRangesInArray as $mediaRange){
            $mediaRangeParsed = self::parseMediaRange($mediaRange);

            $result[] = [
                'type' => $mediaRangeParsed[0],
     ...
     * be used.
     *
     * Mimeparse::bestMatch(array("application/x>bel+xml", "text/xml"), "text/*;q=0.5,*\/*; q=0.1")
     * => "text/xml"
     *
